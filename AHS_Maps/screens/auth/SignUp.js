...
export default function SignUp({ navigation }) {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      // Save user email and name for returning user authentication
      const userData = `${email}\n${FirstName}`;
      const fileUri = FileSystem.documentDirectory + 'userInfo.txt';
      await FileSystem.writeAsStringAsync(fileUri, userData, { encoding: FileSystem.EncodingType.UTF8 });
        ...
        <SafeAreaView style={styles.modalOverlay}>
          <View style={styles.modalView}>
            ...
            >
              ...
              <Text style={styles.scrollText2}>
                We take data security seriously and use Firebase's security features to protect your information. However, please note that no method of transmission over the internet or electronic storage is 100% secure.
              </Text>
              ...
              <Text style={styles.scrollText2}>
                We require parental consent for students under 18 to use our app. By allowing your child to use Eagle Maps, you consent to the collection and use of their data as described in this Privacy Policy.
              </Text>

              <Text style={styles.scrollText}>8. Notifications</Text>
              <Text style={styles.scrollText2}>
                We send time-based notifications to users to remind them of their schedules and important events. These notifications are part of the app's functionality.
              </Text>

              <Text style={styles.scrollText}>9. Updates to This Policy</Text>
              <Text style={styles.scrollText2}>
                We may update this Privacy Policy from time to time. We will notify you of any changes by updating the effective date at the top of this Privacy Policy. Continued use of the app after such changes will constitute your consent to the updated policy.
              </Text>

              <Text style={styles.scrollText}>10. Contact Us</Text>
              <Text style={styles.scrollText2}>
                If you have any questions or concerns about this Privacy Policy or our data practices, please contact team@edupathllc.com
              </Text>
            </ScrollView>
