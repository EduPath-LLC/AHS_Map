...
export default function SignUp({ navigation }) {
  ...
  // Fix for Android scrolling issues with the modal
  const renderPrivacyPolicyContent = () => {
    return (
      <>
        ...
        {/* Added padding at the bottom to ensure content is scrollable past buttons on Android */}
  ...
  return (
    <View style={styles.fullScreen}>
      ...
      {/* Modified Modal Implementation for better Android support */}
      <Modal
        animationType="slide"
        transparent={true}
      ...
      >
        <View style={styles.modalContainer}>
          ...
          {/* Modified ScrollView to better handle Android scrolling */}
          <ScrollView 
            style={[styles.scrollStyle, { flex: 1 }]}
          ...
          {/* Move checkbox and buttons outside ScrollView for better accessibility */}
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
            <Pressable 
              style={[styles.button, { backgroundColor: '#F66060', flex: 1, marginRight: 5 }]}
              onPress={() => {
                setModalVisible(false);
                setPPAccept(false);
              }}
            ...
            <Pressable 
              style={[
                styles.button, 
                { flex: 1, marginLeft: 5 },
                !ppAccept && styles.buttonDisabled
              ]} 
